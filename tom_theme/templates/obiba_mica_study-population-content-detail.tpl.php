  ...
  <div class="scroll-content-tab">
    <table class="table table-striped">
      ...
      <?php if (!empty($population->model->selectionCriteria->areaResidence)): ?>
        <tr>
          <th><?php print $localize->getTranslation("study_taxonomy.vocabulary.populations-selectionCriteria-areaResidence.title"); ?></th>
          <td>
            <?php print $localize->getTranslation("study_taxonomy.vocabulary.populations-selectionCriteria-areaResidence.term." . $population->model->selectionCriteria->areaResidence . ".title"); ?>
          </td>
        </tr>
      <?php endif; ?>
