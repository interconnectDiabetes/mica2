    ...
    <div class="row">
      <div class="col-lg-6 col-xs-12 ">
        ...
        <table class="table table-striped">
          ...
          <?php if (!empty($study_dto->model->info_public)): ?>
            <tr>
              <th><?php print t('Where was the information about this study obtained from?') ?></th>
              <td>
                <p><?php print $study_dto->model->info_public; ?></p>
              </td>
            </tr>
          <?php endif; ?>
      ...
      <div class="col-lg-6  col-xs-12">
        ...
        <table class="table table-striped">
          ...
          <?php if (!empty($study_dto->model->timeline)): ?>
				  <?php if (!empty($study_dto->model->timeline->startYearRec)): ?>
					  ...
					  <?php if (!empty($study_dto->model->timeline->continueRec)): ?>
					   <tr>
						<th><?php print t('Is recruitment continuing?') ?></th>
						<td><p><?php print $study_dto->model->timeline->continueRec; ?></p></td>
					  </tr>
          ...
          <?php if (!empty($study_dto->model->recruitmentIC)): ?>
            <tr>
              <th><?php print t('Type of people (individuals, families, twins etc.) targeted by the study design') ?></th>
              <td>
                    <p><?php print $study_dto->model->recruitmentIC; ?></p>
      ...
      <div class="col-lg-6 col-xs-12">
        ...
        <div class="table-responsive">
          <table class="table table-striped valign-table-column">
            ...
            <tr>
              <th><?php print t('Does the study have any measures of diet?') ?></th>
              <td>
                <p><?php print ($study_dto->model->measureDiet); ?></p>
              </td>
            </tr>
			<?php endif; ?>
            ...
            <tr>
              <th><?php print t('Does the study have DNA extracted or have a potential source of DNA?') ?></th>
              <td>
                <p><?php print ($study_dto->model->measureDNA); ?></p>
              </td>
            </tr>
			<?php endif; ?>
            ...
            <tr>
              <th><?php print t('Does the study have any measures of physical activity?') ?></th>
              <td>
                <p><?php print ($study_dto->model->measurePA); ?></p>
              </td>
            </tr>
			<?php endif; ?>
